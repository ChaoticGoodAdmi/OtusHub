...
ENV SPRING_DATASOURCE_URL=jdbc:postgresql://pgpool:5432/postgres
ENV SPRING_DATASOURCE_USERNAME=postgres
ENV SPRING_DATASOURCE_PASSWORD=pass
ENV SPRING_FLYWAY_URL=jdbc:postgresql://host.docker.internal:5432/postgres
ENV SPRING_FLYWAY_USER=postgres
ENV SPRING_FLYWAY_PASSWORD=pass
